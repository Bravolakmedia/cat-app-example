import { CAT721Proto, PrevoutsCtx, SHPreimage, SigHashUtils, SpentScriptsCtx, StateUtils, TxUtil, TxoStateHashes, int32 } from '@cat-protocol/cat-sdk';
import type { ByteString, PubKey, Sig, FixedArray } from 'scrypt-ts'; // Type-only import
import { SmartContract, assert, hash160, method, prop, sha256 } from 'scrypt-ts';
